  ...
  return (
    <div>
      <div
        ...
        className="flex items-center justify-between px-3 py-2 rounded-xl hover:bg-slate-100 cursor-pointer"
      >
      ...
      {hasChildren && open && (
        <div className="ml-6 space-y-1">
          {item.children.map((sub) => (
            <div key={sub.label} className="px-3 py-1 text-sm text-slate-500">
              {sub.label}
            </div>
          ))}
        </div>
  ...
  return (
    <main className="h-screen overflow-hidden bg-[#f5f8fb] text-slate-900">
      <div className="flex h-full">
        {/* ✅ SIDEBAR (same as first page structure) */}
        {/* <aside className="w-[250px] h-full overflow-y-auto bg-white border-r p-4">
        ...
        <aside className="hidden w-[250px] h-full overflow-y-auto shrink-0 border-r border-slate-200 bg-white px-5 py-6 xl:block h-screen overflow-y-auto sticky top-0">
      {/* <aside className="sidebar-scroll hidden w-[250px] shrink-0 border-r border-slate-200 bg-white px-5 py-6 xl:block h-screen sticky top-0"> */}
        ...
        {/* ✅ MAIN AREA (FIRST PAGE STRUCTURE APPLIED) */}
        <div className="flex-1 flex flex-col h-full">
          {/* ✅ STICKY HEADER */}
          <div className="sticky top-0 z-10 bg-white border-b p-4 shadow">
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {/* 🔥 ALL SECOND PAGE CONTENT GOES HERE */}
            {/* (I kept structure intact, just placed inside scroll container) */}
            ...
            <div className="space-y-6">
                ...
                <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_24px_60px_-38px_rgba(15,23,42,0.35)]">
                  ...
                  <div className="mt-6 rounded-[24px] bg-slate-900 p-5 text-white">
                    ...
                    <p className="mt-3 max-w-xs text-sm leading-6 text-slate-300">
                      Maintain this pace to cross your quarterly target before
                      the final month.
                    </p>
              ...
              {/* KEEP ADDING ALL YOUR ORIGINAL CONTENT HERE */}
              {/* charts, graphs, sections — nothing removed */}
            </div>
          </div>
        </div>
      </div>
