...
export default function Toast({ message, type = "success", onClose, duration = 3000 }) {
  ...
  return (
    <div className="fixed top-20 right-6 z-50 animate-in fade-in slide-in-from-top-4 duration-300 flex items-center gap-3 px-4 py-3 rounded-2xl bg-slate-900/95 text-white text-xs font-semibold shadow-2xl border border-slate-700/80 backdrop-blur-md max-w-md">
